...
export const contact = defineSection({
  hy: {
    ...
    phone2: "094 505 552",
    /*
     * Рабочий ящик центра, подтверждён 21.09.2026 — на него же приходят
     * уведомления о заявках. До этого здесь стоял info@areve-kids.am
     * из исходного лендинга: такого домена не существует, и письмо
     * родителя возвращалось бы с ошибкой.
     */
    email: "arevecenter@gmail.com",
