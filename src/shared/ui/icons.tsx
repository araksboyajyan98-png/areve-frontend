...
// ── Ценности ──────────────────────────────────────────────────
/*
 * Контур замкнут, и обе половины сходятся в одной точке (11, 21).
 *
 * В оригинале путь начинался в (12, 21), а заканчивался в (10, 21) — на два
 * деления левее — и не замыкался. Внизу сердца две обводки с круглыми концами
 * налезали друг на друга, и было видно пересечение. Теперь там стык линий,
 * а не два конца.
 */
export const HeartIcon = (p: IconProps) => (
  <Svg {...p}>
    <path d="M11 21s-7-4.35-8.5-8.5C.5 8.5 2.5 4.5 6.5 4.5c2 0 3.5 1.2 4.5 2.6C12 5.7 13.5 4.5 15.5 4.5c4 0 6 4 4 8-1.5 4.15-8.5 8.5-8.5 8.5Z" />
  </Svg>
);
